var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 490, 430, 30, 30, 1),
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 860, 400, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 340, 480, 30, 15, 1),
    new Obstaculo('imagenes/bache.png', 300, 480, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 500, 130, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 810, 450, 30, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',150,150,10,10,1,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png',140,350,10,10,2,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie3.png',149,350,10,10,1,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie4.png',150,410,10,10,2,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieConductor('imagenes/tren_horizontal.png',400,322,90,30,3,{desdeX: 0, hastaX: 961, desdeY: 322, hastaY: 322},'horizontal'),
    new ZombieConductor('imagenes/tren_vertical.png',604,0,30,90,2,{desdeX: 604, hastaX: 604, desdeY: 0, hastaY: 577},'vertical'), 
    new ZombieConductor('imagenes/tren_vertical.png',630,0,30,90,1,{desdeX: 630, hastaX: 630, desdeY: 0, hastaY: 577},'vertical'),
    new ZombieConductor('imagenes/tren_vertical.png',648,0,30,90,3,{desdeX: 648 , hastaX: 648, desdeY: 0, hastaY: 577},'vertical')
...
// Sugerencia crear una funcion que llame a moverse y cambiar sprite
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    de sus metodos  */
    this.jugador.moverse(movX + this.jugador.x, movY + this.jugador.y);
    this.jugador.cambiarSprite(tecla);    
  }
};
...
Juego.dibujar = function() {
  ...
  // El dibujante remarca donde tiene que llegar el jugador para ganar
  Dibujante.dibujarRectangulo('yellow',760,556,127,8);
};
